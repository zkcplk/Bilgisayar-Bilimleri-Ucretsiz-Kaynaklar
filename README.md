# Bilgisayar Bilimleri ücretsiz video ve pdf ders notları...
...
- [Veritabanı Sistemleri](#veritabanı-sistemleri)
- [Yazılım Mühendisliği](#yazılım-mühendisliği)
- [Yapay Zeka](#yapay-zeka)
- [Makine Öğrenmesi](#makine-öğrenmesi)
- [Web Programlama ve Internet Teknolojileri](#web-programlama-ve-internet-teknolojileri)
- [Bilgisayar Ağları](#bilgisayar-ağları)
- [Bilgisayar Bilimciler için Matematik](#bilgisayar-bilimciler-için-matematik)
- [Teorik Bilgisayar Bilimleri ve Programlama Dilleri](#teorik-bilgisayar-bilimleri-ve-programlama-dilleri)
- [Gömülü Sistemler](#gömülü-sistemler)
- [Bilgisayar Organizasyonu ve Mimarisi](#bilgisayar-organizasyonu-ve-mimarisi)
- [Güvenlik](#güvenlik)
- [Bilgisayar Grafikleri](#bilgisayar-grafikleri)
- [Görüntü İşleme ve Bilgisayarla Görü](#görüntü-i̇şleme-ve-bilgisayarla-görü)
- [Kuantum Hesaplama](#kuantum-hesaplama)
- [Robotik](#robotik)
- [Blockchain Geliştirme](#blockchain-geliştirme)
- [Diğer](#diğer)
...
- **Makine Öğrenmesi Tabanlı Bilgisayarla Görü**
...
- **Zaman Serileri Analizi**
  ...
  - 
- **Karışık Makine Öğrenmesi Konuları**
...
### Bilgisayar Bilimciler için Matematik
...
### Teorik Bilgisayar Bilimleri ve Programlama Dilleri
